...
1) Film search (Use this API endpoint https://api.themoviedb.org/3/search/movie?api_key=APIKEY&query=<search_query> (GET)), display the films in what ever UI you want.
2) The user should be able to see details of the film (Use this API endpoint https://api.themoviedb.org/3/movie/<id>?api_key=APIKEY (GET))
